...
namespace Microsoft.EntityFrameworkCore.Cosmos.Query.Pipeline
{
    public abstract class SqlExpressionVisitor : ExpressionVisitor
    {
        protected override Expression VisitExtension(Expression extensionExpression)
        {
            switch (extensionExpression)
            {
                ...
                case ArrayProjectionExpression arrayProjectionExpression:
                    return VisitArrayProjection(arrayProjectionExpression);
        ...
        protected abstract Expression VisitArrayProjection(ArrayProjectionExpression arrayProjectionExpression);
